...
export class CntCuentasMComponent {
  ...
  ngOnInit() {
    ...
    this.grupos = [
      { id_grupo: 1, cod_clase: 100, cod_grupo: 1000, nombre_grupo: 'Grupo 1' },
      { id_grupo: 2, cod_clase: 200, cod_grupo: 2000, nombre_grupo: 'Grupo 2' },
      // Agrega más grupos según tus datos
    ];
  }
