...
getCostosServicios(codServicio : number){
  ...
  let datos = {"action": actions.actionSelect ,
               "_tabla" : vistas.vehiculos_servicios_costos, "_where" : where  
              };
  console.log('servicios de costo servicio activo - getCostosServicios' ,url.action , datos, httpOptions());
...
guardarNuevoIngresoServicioold(nuevoTipo:VehiculosIngresoServicioModule){ 
  ...
  /************************************************/
  let datos = {"action": actions.actionInsertarDocumentoPorServicioIngresado , 
...
guardarNuevoIngresoServicio(nuevoTipo:VehiculosIngresoServicioModule){ 
  ...
  console.log(' servicios de vehiculos activo guardarNuevoIngresoServicio' ,url.action , datos, httpOptions());
  return this.http.post(url.action , datos, httpOptions()) ;
 }
 //-----------------------
guardarCostoServicio(nuevoTipo:ServiciosCostosModule){ 
  ...
  let datos = {"action": actions.actionInsert ,
   ...
   datos = {"action": actions.actionInsertSelect ,
    "_tabla" : TABLA.vehiculos_servicios_costos,
...
getServiciosPorTipo( tipo:number){
  ...
  let datos = {"action": actions.actionSelect ,
               "_tabla" : vistas.vehiculos_servicios, "_where" : where  
              };
  console.log('servicios de usuarios activo - getUsuarios' ,url.action , datos, httpOptions());
  return this.http.post(url.action , datos, httpOptions()) ;
} 
...
getVehiculos_propietario( tipo:string){
  ...
  let datos = {"action": actions.actionSelect ,
               "_tabla" : vistas.vehiculos_propietario, "_where" : where  
              };
  console.log('servicios de VEHICULOS activo - getVehiculos_propietario' ,url.action , datos, httpOptions());
  return this.http.post(url.action , datos, httpOptions()) ;
} 
...
eliminarTiposServicios(oldTipoVh:TiposServiciosModule){ 
 ...
 public guardarTiposServicios(nuevoTipo : TiposServiciosModule){
  ...
  console.log('servicios de creacion tipo de vehiculo activo' ,url.action , datos, httpOptions());
  return this.http.post(url.action , datos, httpOptions()) ;
 }
